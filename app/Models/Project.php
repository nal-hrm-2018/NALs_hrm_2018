...
class Project extends Model
{
    ...
    protected $fillable = ['id','name', 'income', 'real_cost', 'description', 'status_id', 'start_date', 'estimate_end_date', 'end_date', 'last_updated_at', 'last_updated_by_employee', 'created_at', 'created_by_employee', 'delete_flag'];
