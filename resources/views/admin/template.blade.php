...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{!! asset('admin/templates/css/contain/employees.css') !!}">
...
<script src="{!! asset('admin/templates/css/contain/employees.js') !!}"></script>
