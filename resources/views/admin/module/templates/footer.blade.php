...
<!-- jvectormap -->
<script src="{!! asset('admin/templates/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') !!}"></script>
<script src="{!! asset('admin/templates/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') !!}"></script>
<!-- jQuery Knob Chart -->
<script src="{!! asset('admin/templates/js/bower_components/jquery-knob/dist/jquery.knob.min.js') !!}"></script>
<!-- daterangepicker -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="{!! asset('admin/templates/js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') !!}"></script>
<!-- Slimscroll -->
...
<script src="{!! asset('admin/templates/js/dist/js/pages/dashboard.js') !!}"></script>
