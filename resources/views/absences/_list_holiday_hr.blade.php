        ...
        <div class="input-group-btn">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                @for ($i = $min_year; $i <= $max_year+1; $i++)
                    <a class="dropdown-item" href="javascript:void(0)" onclick="searchTableDevice(this.innerHTML)">{{$i}}</a>
                @endfor
...
<script>
    window.onload = function() {
        searchTableDevice($('#year_now').val());
    };
    $(function () {
    ...
    function searchTableDevice(year) {
        $("#deviceSelector").html(year);
